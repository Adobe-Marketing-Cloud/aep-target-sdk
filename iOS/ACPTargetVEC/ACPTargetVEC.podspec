Pod::Spec.new do |s|
  ...
  s.source       = { :git => 'git@github.com:Adobe-Marketing-Cloud/aep-target-sdk.git', :tag => "v0.6.1-ACPTargetVEC" }
  s.dependency "ACPCore"
  s.dependency "ACPTarget"

  s.requires_arc = true
  s.vendored_libraries = "iOS/TargetVEC/libACPTargetVEC.a"
  s.source_files = 'iOS/TargetVEC/include/*.h', "iOS/TargetVEC/include/*.m"
